...
public final class DiretorValidation
{
	private DiretorValidation()
	{
	}
  ...
  public static boolean validationNomeExiste(String nome, List<Diretor> diretores)
  {
